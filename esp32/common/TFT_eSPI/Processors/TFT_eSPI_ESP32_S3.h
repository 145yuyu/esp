...
// Note illogical enumerations: FSPI_HOST=SPI2_HOST=1   HSPI_HOST=SPI3_HOST=2
  ...
  // Override soc.h's REG_SPI_BASE which returns 0 for SPI port < 2 (crash!)
  // Arduino core defines FSPI=0, HSPI=1 for ESP32-S3; map them to valid bases.
  #undef  REG_SPI_BASE
  #define REG_SPI_BASE(i) (((i)==0) ? DR_REG_SPI2_BASE : \
                           ((i)==1) ? DR_REG_SPI3_BASE : \
